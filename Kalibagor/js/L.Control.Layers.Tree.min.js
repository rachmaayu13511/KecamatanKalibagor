...
var tree = L.control.layers.tree(baseTree, overlaysTree, {
    // 1. Hilangkan simbol teks agar tidak bentrok dengan CSS
    closedSymbol: '', 
    openedSymbol: '', 
    spaceSymbol: '',
    
    // 2. Posisi di kiri atas
    position: 'topleft', 
    
    // 3. Wajib true agar menjadi ikon hamburger
    collapsed: true 
}).addTo(map);